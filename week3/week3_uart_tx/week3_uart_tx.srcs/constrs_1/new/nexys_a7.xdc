...
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { tx_busy_led }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { btn_send }]; #IO_L4N_T0_D05_14 Sch=btnu
...
## Coin - BTNU
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports coin]

## Select - BTNR
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports select]

## Vend - LED[0]
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports vend]

## State Out - LED[2:1]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports {state_out[0]}]
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports {state_out[1]}]